defmodule RiseShop.Backoffice.Admin do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, RiseShop.Repo)
  ...
  """
  def valid_password?(%RiseShop.Backoffice.Admin{hashed_password: hashed_password}, password)
