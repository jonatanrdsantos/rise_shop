defmodule RiseShopWeb.AdminAuth do
  use RiseShopWeb, :verified_routes

  import Plug.Conn
  import Phoenix.Controller

  alias RiseShop.Backoffice

  # Make the remember me cookie valid for 60 days.
  # If you want bump or reduce this value, also change
  # the token expiry itself in AdminToken.
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_rise_shop_web_admin_remember_me"
  ...
  the current_admin:
      ...
      defmodule RiseShopWeb.PageLive do
        ...
        on_mount {RiseShopWeb.AdminAuth, :mount_current_admin}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{RiseShopWeb.AdminAuth, :ensure_authenticated}] do
